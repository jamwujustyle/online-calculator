        ...
        <div className="w-full lg:w-96 lg:border-l border-t lg:border-t-0 border-gray-800 bg-dark-900/50 flex flex-col shrink-0 min-h-[400px]">
            <div className="flex-1 overflow-y-auto p-6 custom-scrollbar space-y-6">
                <h2 className="text-lg font-semibold text-white flex items-center gap-2">
                    <Calculator className="text-primary-500" size={20} /> Cost Breakdown
                </h2>
                ...
                {results ? (
                    <>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="bg-dark-800 p-4 rounded-xl border border-gray-700 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs text-gray-400">Operations & Power</p>
                            ...
                            <div className="bg-dark-800 p-4 rounded-xl border border-gray-700 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs text-gray-400">Labor & Prep</p>
                        ...
                        <div className="pt-6 border-t border-gray-800">
                            ...
                            >
                                <Sparkles size={18} />
                                {generatingAi ? 'Generating Descriptions...' : 'Generate AI Descriptions'}
                            </button>

                            {project.ai_description && (
                                <div className="mt-6 space-y-4">
                                    <div>
                                        <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Technical Description</h4>
                                    ...
                                    {project.ai_commercial_text && (
                                        <div>
                                            <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Commercial Pitch</h4>
                                            <div className="bg-dark-800 p-3 rounded-lg border border-gray-700 text-sm text-gray-300 leading-relaxed">
                                                {project.ai_commercial_text}
                                            </div>
                                        </div>
                    ...
                    <div className="text-center py-12 text-gray-500 border border-dashed border-gray-700 rounded-xl">
                        ...
                        <p>Upload a model and wait for processing to see calculations.</p>
                    </div>
                )}
